(() => {
  ...
  (function() {
      ...
      const flushList = () => {
        if (listItems.length > 0) {
          elements.push(React.createElement(
            "ul",
            { key: "list-" + elements.length, className: "sf-preview-list" },
    ...
    function CommunityCard({ item, onUse, onDelete }) {
      return React.createElement(
        Card,
        { className: "sf-community-card" },
        React.createElement(
          CardHeader,
          null,
          React.createElement(
            "div",
            { className: "sf-community-header" },
            React.createElement(CardTitle, { className: "sf-community-name" }, item.name),
            React.createElement(
              "div",
              { className: "sf-community-actions" },
        ...
        React.createElement(
          ...
          React.createElement(
            "pre",
            { className: "sf-community-preview" },
    ...
    function SoulForge() {
      ...
      const showToast = useCallback((msg, type, duration) => {
        setToast({ msg, type });
        setTimeout(() => setToast(null), duration || 3e3);
      }, []);
      ...
      const handleSave = useCallback(async () => {
        ...
        try {
          ...
          showToast(`Saved to ${path} \u2014 loads on next session`, "success", 5e3);
        } catch (err) {
      ...
      return React.createElement(
        ...
        // ─── Templates Tab ───────────────────────────────────────────
        activeTab === "templates" && React.createElement(
          "div",
          ...
          React.createElement(
            ...
            { className: "sf-grid" },
            templates.map(
              (t) => React.createElement(TemplateCard, {
                key: t.id,
                template: t,
        ...
        activeTab === "generate" && React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              selectedTemplate && React.createElement(
                "div",
                { className: "sf-selected-template" },
                React.createElement(Badge, { variant: "secondary" }, "Based on: " + templates.find((t) => t.id === selectedTemplate)?.name),
                React.createElement("button", { className: "sf-clear-btn", onClick: () => {
              ...
              React.createElement(
                "div",
                { className: "sf-reference-section" },
                React.createElement("button", {
                  className: "sf-reference-toggle",
                  onClick: () => setShowReference(!showReference)
                }, showReference ? "\xD7 Clear reference" : "+ Add a reference SOUL.MD")
              ),
              showReference && React.createElement(
                "div",
                { className: "sf-reference-box" },
                React.createElement("label", { className: "sf-label" }, "Reference SOUL.MD \u2014 paste an existing one to match its style:"),
                React.createElement("textarea", {
                  className: "sf-textarea sf-reference-textarea",
                  rows: 8,
        ...
        activeTab === "preview" && React.createElement(
          ...
          !generated ? React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "sf-preview-header" },
                React.createElement(CardTitle, null, "Generated SOUL.MD"),
                React.createElement(
                  "div",
                  { className: "sf-preview-actions" },
                  React.createElement(Button, {
                    variant: "ghost",
                    size: "sm",
                    onClick: () => {
                      setEditing(!editing);
                      if (!editing) setEditContent(generated);
                    }
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "sf-save-section" },
                React.createElement(
                  "div",
                  { className: "sf-save-row" },
        ...
        // ─── Community Tab ───────────────────────────────────────────
        activeTab === "community" && React.createElement(
          "div",
          { className: "sf-content" },
          React.createElement(
            "div",
            { className: "sf-community-top" },
            React.createElement(
              "p",
              { className: "sf-hint" },
          ...
          showAddForm && React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("input", {
                className: "sf-input",
                placeholder: "Name (e.g., 'Reddit Coder SOUL')",
                value: newName,
          ...
          // Community list
          community.length === 0 && !showAddForm ? React.createElement(
            "div",
            { className: "sf-empty-state" },
            React.createElement("p", null, "No community SOUL.MD files yet. Add one from Reddit, GitHub, or anywhere!")
          ) : React.createElement(
            "div",
            { className: "sf-community-grid" },
            community.map(
              (item) => React.createElement(CommunityCard, {
                key: item.id,
                item,
